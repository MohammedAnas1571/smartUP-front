      ...
      <div className="max-w-[1640px] mx-auto p-4">
        <div className="max-h-[500px] relative">
          <div className="absolute w-full h-full text-white  flex flex-col justify-center">
            {/* <h1 className="pl-8 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">
              Experience
            </h1>
            <p className="pl-8 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">
              The Best <span className="text-orange-600">Learning</span> with Us
            </p> */}
          </div>
          <img
            ...
            alt="Online Certification Illustration"
          />
        </div>
      </div>
